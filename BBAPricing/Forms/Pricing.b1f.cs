    ...
    class Pricing : UserFormBase
    {
        ...
        private void Button2_PressedAfter(object sboObject, SBOItemEventArg pVal)
        {
            try
            {
                ...
                mBomMtrlRow.Percent = mBomTotals.Cost == 0 ? 0 : Math.Round(mBomMtrlRow.Cost / mBomTotals.Cost * 100, 4);

                var mBomSalaryFundRow = MasterBomModel.Rows.First(x => x.ElementID == "SalaryFund" && x.ParentItemCode == MasterBomModel.ParentItem);
                mBomSalaryFundRow.Percent = mBomTotals.Cost == 0 ? 0 : Math.Round(mBomSalaryFundRow.Cost / mBomTotals.Cost * 100, 4);
                ...
                mBomMachinaryRow.Percent = mBomTotals.Cost == 0 ? 0 : Math.Round(mBomMachinaryRow.Cost / mBomTotals.Cost * 100, 4);

                var mBomHumanRow = MasterBomModel.Rows.First(x => x.ElementID == "Human Resources" && x.ParentItemCode == MasterBomModel.ParentItem);
                mBomHumanRow.Percent = mBomTotals.Cost == 0 ? 0 : Math.Round(mBomHumanRow.Cost / mBomTotals.Cost * 100, 4);
                ...
                mBomManufacturingRow.Percent = mBomTotals.Cost == 0 ? 0 : Math.Round(mBomManufacturingRow.Cost / mBomTotals.Cost * 100, 4);
                ...
                mBomAdministrativeRow.Percent = mBomTotals.Cost == 0 ? 0 : Math.Round(mBomAdministrativeRow.Cost / mBomTotals.Cost * 100, 4);
                ...
                mBomTripRow.I = mBomTotals.Margin == 0 ? 0 : mBomTripRow.Margin / mBomTotals.Margin * 100;
                mBomTransportRow.I = mBomTotals.Margin == 0 ? 0 : mBomTransportRow.Margin / mBomTotals.Margin * 100;

                var mBomReferenceFeeRow = MasterBomModel.Rows.First(x => x.ElementID == "Reference Fee" && x.ParentItemCode == MasterBomModel.ParentItem);
                mBomReferenceFeeRow.Percent = mBomTotals.Cost == 0 ? 0 : Math.Round(mBomReferenceFeeRow.Cost / mBomTotals.Cost * 100, 4);

                mBomTransportRow.II = mBomTransportRow.FinalCustomerPrice == 0 ? 0 : mBomTransportRow.Margin / mBomTransportRow.FinalCustomerPrice * 100;
                mBomTripRow.III = mBomTotals.FinalCustomerPrice == 0 ? 0 : mBomTripRow.Margin / mBomTotals.FinalCustomerPrice * 100;
                mBomTransportRow.III = mBomTotals.FinalCustomerPrice == 0 ? 0 : mBomTransportRow.Margin / mBomTotals.FinalCustomerPrice * 100;
                mBomTripRow.II = mBomTripRow.FinalCustomerPrice == 0 ? 0 : mBomTripRow.Margin / mBomTripRow.FinalCustomerPrice * 100;

                mBomTripRow.Percent = mBomTotals.Cost == 0 ? 0 : Math.Round(mBomTripRow.Cost / mBomTotals.Cost * 100, 4);
                mBomTransportRow.Percent = mBomTotals.Cost == 0 ? 0 : Math.Round(mBomTransportRow.Cost / mBomTotals.Cost * 100, 4);
                ...
                mBomMaterialOverHeadsRow.Percent = mBomTotals.Cost == 0 ? 0 : Math.Round(mBomMaterialOverHeadsRow.Cost / mBomTotals.Cost * 100, 4);
                ...
                mBomMtrlRow.II = mBomMtrlRow.FinalCustomerPrice == 0 ? 0 : mBomMtrlRow.Margin / mBomMtrlRow.FinalCustomerPrice * 100;
                mBomSalaryFundRow.II = mBomSalaryFundRow.FinalCustomerPrice == 0 ? 0 : mBomSalaryFundRow.Margin / mBomSalaryFundRow.FinalCustomerPrice * 100;
                mBomMachinaryRow.II = mBomMachinaryRow.FinalCustomerPrice == 0 ? 0 : mBomMachinaryRow.Margin / mBomMachinaryRow.FinalCustomerPrice * 100;
                mBomHumanRow.II = mBomHumanRow.FinalCustomerPrice == 0 ? 0 : mBomHumanRow.Margin / mBomHumanRow.FinalCustomerPrice * 100;
                mBomAdministrativeRow.II = mBomAdministrativeRow.FinalCustomerPrice == 0 ? 0 : mBomAdministrativeRow.Margin / mBomAdministrativeRow.FinalCustomerPrice * 100;

                mBomMaterialOverHeadsRow.II = mBomMaterialOverHeadsRow.FinalCustomerPrice == 0 ? 0 : mBomMaterialOverHeadsRow.Margin / mBomMaterialOverHeadsRow.FinalCustomerPrice * 100;
                mBomManufacturingRow.II = mBomManufacturingRow.FinalCustomerPrice == 0 ? 0 : mBomManufacturingRow.Margin / mBomManufacturingRow.FinalCustomerPrice * 100;
                var sumII = Math.Round(MasterBomModel.Rows.Where(y => y.ElementID != "Totals").Sum(x => x.II), 4);
                mBomTotals.II = sumII;
                mBomMtrlRow.III = mBomTotals.FinalCustomerPrice == 0 ? 0 : mBomMtrlRow.Margin / mBomTotals.FinalCustomerPrice * 100;
                mBomSalaryFundRow.III = mBomTotals.FinalCustomerPrice == 0 ? 0 : mBomSalaryFundRow.Margin / mBomTotals.FinalCustomerPrice * 100;
                mBomMachinaryRow.III = mBomTotals.FinalCustomerPrice == 0 ? 0 : mBomMachinaryRow.Margin / mBomTotals.FinalCustomerPrice * 100;
                mBomHumanRow.III = mBomTotals.FinalCustomerPrice == 0 ? 0 : mBomHumanRow.Margin / mBomTotals.FinalCustomerPrice * 100;
                mBomAdministrativeRow.III = mBomTotals.FinalCustomerPrice == 0 ? 0 : mBomAdministrativeRow.Margin / mBomTotals.FinalCustomerPrice * 100;
                mBomMaterialOverHeadsRow.III = mBomTotals.FinalCustomerPrice == 0 ? 0 : mBomMaterialOverHeadsRow.Margin / mBomTotals.FinalCustomerPrice * 100;
                mBomManufacturingRow.III = mBomTotals.FinalCustomerPrice == 0 ? 0 : mBomManufacturingRow.Margin / mBomTotals.FinalCustomerPrice * 100;
